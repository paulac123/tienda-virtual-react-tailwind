...
const Card = (data) =>{
    ...
    onClick={(event) => {
        event.stopPropagation(); // Evita que el clic llegue a `showProduct`
        event.preventDefault();  // Refuerza que no siga la navegación
        console.log("CLICK EN EL +"); // Prueba si este mensaje se imprime
